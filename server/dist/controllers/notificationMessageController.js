...
export const getMyMessageNotifications = async (req, res, next) => {
    try {
        if (!req.user) {
...
export const markMessageNotificationAsRead = async (req, res, next) => {
    try {
        if (!req.user) {
            throw new AppError("Unauthorized", 401);
        }
...
export const markAllMessageNotificationsAsRead = async (req, res, next) => {
    try {
        if (!req.user) {
            throw new AppError("Unauthorized", 401);
        }
